...
public class IndexActivity extends BaseActivity {
	...
	protected void onSubActivityClick(View view) {
		...
		case R.id.search_btn:
			MobclickAgent.onEvent(this, "um_search");
			...
			break;
		case R.id.baby_btn:
			MobclickAgent.onEvent(this, "um_click_ultimate");
			intent = new Intent(this, GreedActivity.class);
			startActivity(intent);
			break;
		case R.id.barcode_btn:
			MobclickAgent.onEvent(this, "um_barcode");
	...
	protected void onResume() {
		...
		System.out.println("listSuccess:" + listSuccess + "  gallerySuccess:" + gallerySuccess);
		if (!gallerySuccess) {
	...
	protected void dealwithMessage(Message msg) {
		...
		case GALLERY_SUCCESS:
			if (galleryHandler.getPicBeans() != null && galleryHandler.getPicBeans().size() > 0) {
				picBeans.clear();
